...
/** * Implementação da interface questao1.Stack usando um arranjo de tamanho fixo.
 ...
 * * métodos da classe Java predefinida java.util.questao1.Stack
 *
 */
public class ArrayStack<E>  implements Stack<E> {
		...
		public void push(E element) throws FullStackException {
			if (size() == capacity)
					throw new FullStackException("questao1.Stack is full.");
			S[++ top] = element;
			} 
